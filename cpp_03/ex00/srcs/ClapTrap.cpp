...
/*   Updated: 2025/06/15 01:12:59 by GP               ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(const std::string& name) : name(name) {
    ...
    energyPoints = 10;
    attackDamage = 0;
    std::cout << BLUE "ClapTrap constructor has been called" RESET << std::endl;
}

ClapTrap::ClapTrap(const ClapTrap& other)
{
    std::cout << BLUE "ClapTrap copy constructor has been called" RESET << std::endl;
    *this = other;
}
...
ClapTrap::~ClapTrap() {
    std::cout << BLUE "ClapTrap destuctor has been called" RESET << std::endl;
}
...
void ClapTrap::beRepaired(unsigned int amount)
{
    ...
    {
        if (this->hitPoints <= 0)
            std::cout << "This " << this->getName() << " cannot be repaired because it's lacking hitPoints" << std::endl;
        else if (this->energyPoints <= 0)
            std::cout << "This " << this->getName() << " cannot be repaired because it's lacking energyPoints" << std::endl;
    }
    else
    { 
